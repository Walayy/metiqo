...
- Jusqu’à 680 px de large, tous les dialogues et la navigation s’ouvrent en bottom sheet. La poignée de 44 px permet de rabattre, remonter ou fermer la feuille par glissement ; les gestes de défilement dans le contenu restent indépendants. Escape, le bouton Fermer et le retour du focus sont conservés. L’ouverture d’un formulaire mobile cible la poignée pour éviter d’afficher le clavier avant le choix du champ. Au-delà de 680 px, les dialogues restent centrés. La préférence de réduction des mouvements supprime les animations de la feuille et du fond.
