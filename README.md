...
- Jusqu’à 680 px de large, tous les dialogues et la navigation s’ouvrent en bottom sheet. La poignée tactile de 44 px s’élargit et scintille discrètement pendant la prise ; un balayage franc vers le bas ferme la feuille en un geste, sans arrêt à mi-hauteur. Un mouvement court la ramène en place et le défilement du contenu reste indépendant. Escape, le bouton Fermer et le retour du focus sont conservés. L’ouverture d’un formulaire mobile cible la poignée pour éviter d’afficher le clavier avant le choix du champ. Au-delà de 680 px, les dialogues restent centrés. La préférence de réduction des mouvements supprime les animations de la feuille, de la poignée et du fond.
