...
- **Correctif CI/hash :** `55d9d77758e6f47acafa840279a99bc60dfc83af` (`test: stabilize Playwright across platforms`) ajoute les baselines Linux et rend les clés d'idempotence du parcours mapping stables. Le test mapping passe deux fois de suite contre le même processus mock, puis les 33 tests E2E passent ensemble.
