...
- **Migrations :** aucune ; `max_input_time` et `max_knowledge_time` sont transportés dans l’audit immuable du lot et seront persistés par les feature snapshots de `FEAT-011`.
