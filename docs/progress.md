...
- **Statut :** `IN_PROGRESS` ; les preuves CI distantes restent obligatoires avant clôture.
...
- **Travail restant :** commit dédié, CI verte et CI volontairement rouge sur ce commit ; archivage de leurs preuves. Les preuves locales et leurs limites sont conservées dans `docs/evidence/qa-005/report.json`. QA-006 puis QA-007 restent à exécuter.
